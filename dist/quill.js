...
Editor = (function() {
  ...
  Editor.prototype.focus = function() {
    if ((this.selection.range != null) && dom.isIE(11)) {
...
Format = (function() {
  ...
  Format.prototype.add = function(node, value) {
    var formatNode, inline, k, parentNode, v, wrapperTag, _ref, _ref1, _ref2, _ref3, _ref4;
    if (!value) {
    ...
    if (_.isString(this.config.style) || _.isString(this.config.attribute) || _.isString(this.config["class"])) {
      ...
      if (_.isString((_ref2 = this.config) != null ? (_ref3 = _ref2.wrapper) != null ? _ref3.tag : void 0 : void 0)) {
        wrapperTag = this.document.createElement(this.config.wrapper.tag);
        _ref4 = this.config.wrapper.attributes;
        for (k in _ref4) {
          v = _ref4[k];
